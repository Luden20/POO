...
public class Interfaz_ConFichas extends javax.swing.JFrame {
    ...
    public Interfaz_ConFichas(LinkedHashMap ListaDPacientes) {
        ...
        initComponents();
        String ids [] = {"NROPACIENTE","Paciente","NROFICHA","FECHA","MOTIVO","DOCTOR ENCARGADO"};
    ...
    private void initComponents() {
        ...
        Encabezado.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "LISTA DE FICHAS\n\n", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tw Cen MT", 3, 24), new java.awt.Color(255, 204, 0))); // NOI18N
        ...
        TT_CONSULTAR.setFont(new java.awt.Font("Tw Cen MT", 1, 24)); // NOI18N
        TT_CONSULTAR.setForeground(new java.awt.Color(255, 255, 0));
        ...
        BT_PACIENTE.setFont(new java.awt.Font("Tw Cen MT", 2, 24)); // NOI18N
        ...
        TL_DOC.setFont(new java.awt.Font("Tw Cen MT", 0, 18)); // NOI18N
    ...
    private void TT_CONSULTARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TT_CONSULTARActionPerformed
        ...
        for(Ficha_Medica Ficha:ListaDFichas.values()){
            BXP.addRow(new Object[]{J.getNroPaciente(),J.getNombre()+J.getApellido(),Ficha.getNroCita(),Ficha.getMotivo(),Ficha.getDoctor()});
        }
