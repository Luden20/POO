...
public class Interfaz_Ficha extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Encabezado.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "CREACION DE REGISTRO", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tw Cen MT", 3, 24), new java.awt.Color(255, 204, 0))); // NOI18N
        ...
        BT_REG.setBackground(new java.awt.Color(0, 255, 153));
        BT_REG.setFont(new java.awt.Font("Tw Cen MT", 3, 24)); // NOI18N
        ...
        BT_ACTUAL.setBackground(new java.awt.Color(0, 255, 153));
        BT_ACTUAL.setFont(new java.awt.Font("Tw Cen MT", 3, 24)); // NOI18N
    ...
    private void BT_REGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BT_REGActionPerformed
        ...
        for (Medico Doctor:ListaDMedicos.values()){
            if (Doctor.getNLicencia()==BT_DOC.getSelectedItem().toString()){
