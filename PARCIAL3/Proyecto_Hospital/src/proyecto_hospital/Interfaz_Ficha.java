...
public class Interfaz_Ficha extends javax.swing.JFrame {
    ...
    private void BT_REGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BT_REGActionPerformed
        Ficha_Medica J = null;
        Medico K = ListaDMedicos.get(BT_DOC.getSelectedItem().toString());
        J = new Ficha_Medica(TT_NRO.getText(),TT_MAL.getText(),TT_MEDI.getText(),TT_EXAMENES.getText(),TT_FECHA.getText(),TT_DIAG.getText(),K);
